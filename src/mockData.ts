...
const RAW_INITIAL_LEADS: Array<{ email: string; name?: string; company?: string }> = [
  ...
  { email: 'mladenka.pejic@adria-shipping.hr', company: 'Adria Shipping Logistics' },
  { email: 'mladenka.p@marine-cargo.eu', company: 'Marine Cargo Europe' },
  { email: 'mladenka@vessel-charter.net', company: 'Vessel Charter Group' },
